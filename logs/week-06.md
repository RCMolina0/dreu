...
## Results
- I finished integrating my model into the agent and policy classes
- I removed all the bugs from those classes and fixed the training script as well
- The policy doesn't perform well at all but this doesn't mean its my fault automatically
- With outside data it still is bad but the data also might not be the correct format, I will look at that more next week
